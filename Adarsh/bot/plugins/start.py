    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='http://t.me/blackest_harbour'>CLICK HERE FOR GROUP </a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
            text="""
<i>Hey👋Yo i M ꜰɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ ᴡɪᴛʜ ʙᴏᴛʜ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴᴅ ꜱᴛʀᴇᴀᴍ ʟɪɴᴋ ꜱᴜᴘᴘᴏʀᴛ</i>\n
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @z_harbour",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [BLACK MARKET](https://t.me/blackest_harbour).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
"""
        ...
        await m.reply_text(
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("▶️STREAM", url=stream_link), #Stream Link
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="Send any File from @MdiskLinkSearchBot or from elsewhere and get direct downloadable links",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
   
    await message.reply_text(
       text="Send me any file/media from telegram, I'll provide external fast direct download link..",
            parse_mode="HTML",
            
          reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Our Movie Group", url="https://t.me/blackest_harbour")]
            ]
        )
    )
